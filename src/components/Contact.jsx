  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      className="flex-[0.75] bg-black-100 p-8 rounded=2xl">
        ...
        <h3 className={`${styles.heroSubText}`}>Akshita</h3>
        <p>Shanthi Nagar, Langfored Rd, Bengaluru 560079</p>
        <p>Website: <a href="https://github.com/Akshitarachel">My Github Repository</a></p>
        <p>Phone Number: +91 6364046992</p>
          <p>email: akshitarachel04@gmail.com</p>
